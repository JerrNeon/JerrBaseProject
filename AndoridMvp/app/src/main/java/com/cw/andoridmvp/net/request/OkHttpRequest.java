package com.cw.andoridmvp.net.request;

import android.util.Pair;
import android.widget.ImageView;

import com.cw.andoridmvp.net.OkHttpClientManager;
import com.cw.andoridmvp.net.cache.InterceptorCache;
    ...
    public static class Builder {
        ...
        public OkHttpRequest post(ResultCallback callback) {
            ...
            if (QMUtil.isNotEmpty(params)) {
                ...
                NLogUtil.logD("OkHttpPostRequest json", content);
            }
