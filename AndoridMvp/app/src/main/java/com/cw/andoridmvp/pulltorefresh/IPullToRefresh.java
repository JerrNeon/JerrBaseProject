...
public interface IPullToRefresh<T extends View> {
     ...
     * @param saveTimeKey 存储上次更新时间的唯一id，保证该项目各处使用下拉刷新时间读取不冲突
     */
    public void setOnRefreshListener(PullToRefreshBase.OnRefreshListener<T> refreshListener, int saveTimeKey);
