package com.cw.andoridmvp.util.form;
...
public class FormUtils {
     ...
     * @return
     */
    public static boolean validate(FormEditText... formEditTexts) {
        boolean allValid = true;
        for (FormEditText fet : formEditTexts) {
            allValid = fet.testValidity() && allValid;
        }
        return allValid;
    }
