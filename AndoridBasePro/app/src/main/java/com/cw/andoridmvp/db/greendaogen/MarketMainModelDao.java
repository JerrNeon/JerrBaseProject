...
*/
public class MarketMainModelDao extends AbstractDao<MarketMainModel, Long> {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, MarketMainModel entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, MarketMainModel entity) {
        stmt.clearBindings();
        stmt.bindLong(1, entity.getId());
    ...
    @Override
    public MarketMainModel readEntity(Cursor cursor, int offset) {
        MarketMainModel entity = new MarketMainModel( //
    ...
    @Override
    public void readEntity(Cursor cursor, MarketMainModel entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(MarketMainModel entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(MarketMainModel entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(MarketMainModel entity) {
