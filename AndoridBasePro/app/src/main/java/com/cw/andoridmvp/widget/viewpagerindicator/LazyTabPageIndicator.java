 ...
 */
package com.cw.andoridmvp.widget.viewpagerindicator;
 ...
 */
public class LazyTabPageIndicator extends HorizontalScrollView implements LazyPageIndicator {
    ...
    public LazyTabPageIndicator(Context context, AttributeSet attrs) {
        super(context, attrs);
