package com.cw.jerrbase.util.versionupdate;
...
import com.cw.jerrbase.service.VersionUpdateService;
...
public class VersionUpdateUtils {
    ...
    public static void checkUpdate(Context mContext, Map<String, Object> param, String url, boolean isForceUpdate) {
        ...
        versionField.setVersionServiceName("com.cw.jerrbase.service.VersionUpdateService");
