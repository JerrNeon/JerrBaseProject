 ...
 * @Description: (base 刷新RecyclerView Fragment--->不带懒加载)
 * @create by: chenwei
 * @date 2017/3/16 17:26
 */
public abstract class BaseRvFragment<T> extends BaseFragment implements PullToRefreshBase.OnRefreshListener, BaseRvAdapter.onItemClickListener<T>, BaseRvAdapter.onItemLongClickListener<T> {
